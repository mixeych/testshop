...
{
	// Plugin URL
	$plugin_url = admin_url('plugin-install.php?s=oneall+social+sharing&tab=search&type=term');
		...
		<div class="wrap">
			<div id="oa_social_login_page" class="oa_social_login_more">			
				...
				<table class="form-table oa_social_login_table">
					...
					<tr class="row_even">				
						<td>
							<?php _e ('Easy to use and 100% FREE Social Sharing Icons & Share Buttons for WordPress. Allow your users to share posts and pages to 30+ Social Networks. Integrates with Social Login. No additional setup required.', 'oa_social_login'); ?>
							<strong><a href="<?php echo $plugin_url; ?>"><?php _e ('Click For More Information', 'oa_social_login'); ?></a></strong>
						</td>
					</tr>
				</table>
			</div>
